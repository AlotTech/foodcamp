...
class UserController extends Controller
{
    ...
    {
      $employees = Pegawai::find()->all();
      $employees = ArrayHelper::map($employees,'nip','nama');
    ...
    public function actionCreate()
    {
        ...
        $user = Yii::createObject([
          ...
          $picture = UploadedFile::getInstance($user, 'foto');
 ...
 $user->foto =  $user->nip.'.'.$picture->extension;        
                if($user->create()) {
                    
      if( $picture->extension != null){
 $picture->saveAs(Yii::getAlias('@backend').'/web/uploads/'. $user->nip.'.'.$picture->extension);
 }
